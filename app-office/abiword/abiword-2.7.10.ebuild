...
src_install() {
	...
	#mv "${D}/usr/share/abiword-2.7/applications/abiword.desktop" \
	#	"${D}/usr/share/applications/abiword.desktop"

	dodir /usr/share/applications
	insinto /usr/share/applications
	doins abiword.desktop

	sed "s:Exec=abiword:Exec=abiword-${MY_MAJORV}:" -i "${D}"/usr/share/applications/abiword.desktop || die
...
pkg_postinst() {
	...
	elog "into a separate app-office/abiword-plugins package."
