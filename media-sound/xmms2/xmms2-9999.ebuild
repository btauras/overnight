...
SLOT="0"
KEYWORDS="~amd64"
IUSE="aac alsa ao avahi curl fam flac ffmpeg jack libvisual mad minimal mms modplug mpg123 musepack nocxx ofa perl pulseaudio python readline ruby samba shout sid ssl vocoder vorbis wavpack xml"
...
src_install() {
	...
	./waf --destdir="${D}" --without-ldconfig install || die "install failed"
